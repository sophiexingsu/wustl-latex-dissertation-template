...
\begin{table}
	\caption[Thesis components]{The following items may be included in your dissertation or thesis, in the order in which they are listed.
  Any optional components, if used, \uline{must} be included in the table of contents, unless noted below.}
  \label{tab:include}
	\stretchtable
  \centering
  ...
  Front Matter & Title page & \checkmark & & counted, not numbered \\
  & Copyright page & & \checkmark & neither counted, nor numbered \\
  & Table of Contents & \checkmark & & begins on page number \uline{ii} \\
  & List of Figures & & \checkmark & [lowercase Roman numerals continue] \\
  & List of Illustrations & & \checkmark & [lowercase Roman numerals continue] \\
  & List of Tables & & \checkmark & [lowercase Roman numerals continue] \\
  & List of Abbreviations & & \checkmark & [lowercase Roman numerals continue] \\
  & Acknowledgments & \checkmark & & [lowercase Roman numerals continue] \\
  & Dedication\tnote{*} & & \checkmark & [lowercase Roman numerals continue] \\
  & Abstract page & & \checkmark & [lowercase Roman numerals continue] \\
  & Preface & & \checkmark & [lowercase Roman numerals continue] \\
  Body & Epigraph\tnote{*} & & \checkmark & begins on a page numbered \uline{1} \\
  & Chapters & \checkmark & & [Arabic numerals begin or continue] \\
  Back Matter & References\tnote{**} & \checkmark & & [Arabic numerals continue] \\
  & Appendices & & \checkmark & [Arabic numerals continue] \\
  & Curriculum Vitae\tnote{***} & & \checkmark & [Arabic numerals continue] \\
  \bottomrule
  \end{tabular}
...
\begin{mdframed}\singlespace
  \textit{Example:}\\
  \centerline{© 2017, Paige Turner}\\
\end{mdframed}\vspace{-22pt}
...
Note that personally identifiable information such as birth date, place of birth, and social security number should \uline{NOT} be included.
