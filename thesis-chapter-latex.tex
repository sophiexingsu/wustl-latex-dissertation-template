...
\fref{suppfig:vector} is a supplemental figure.
\fref{suppfig:subfigure-demo} has two panels, \subcaptionref{suppfig:subfigdemo-cat} and \subcaptionref{suppfig:subfigdemo-dog}.
\fref{suppfig:subfigdemo-cat} refers to the cat panel.
...
\begin{suppfigure}[t]
    \begin{subsuppfigure}[b]{.5\linewidth}
        ...
        \HUGE \emoji{cat}\\
        \emoji{cat-face}
        \phantomlabel{suppfig:subfigdemo-cat}
    \end{subsuppfigure}%
    \begin{subsuppfigure}[b]{.5\linewidth}
        \centering
        \textbf{\sffamily B}\\[-0.5\onelineskip]
        \HUGE \emoji{dog}\\
        \emoji{dog-face}
        \phantomlabel{suppfig:subfigdemo-dog}
    \end{subsuppfigure}
    \caption[Supplemental two animals and their emojis.]{%
        Supplemental two animals and their emojis.
        \subref{suppfig:subfigdemo-cat} cats and \subref{suppfig:subfigdemo-dog} dogs.
    }
    \label{suppfig:subfigure-demo}
\end{suppfigure}

\tref{supptab:table-demo} is a supplemental table.
