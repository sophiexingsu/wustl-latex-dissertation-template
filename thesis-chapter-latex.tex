...
In this case, the panel numbers can be created using \cmd{\phantomlabel}.
Both \fref{fig:subfigure-demo} and \ref{fig:cell-cycle-mitosis} create panel numbers using this approach.
